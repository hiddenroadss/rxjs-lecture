...
У наступному прикладі створюється Observable, який щосекунди надсилає підписнику рядок «hi».
...
У наведеному вище прикладі функція підписки є найважливішою частиною для опису Об'єкту Спостереження. Давайте розглянемо, що вона означає.
