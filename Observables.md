...
Observables створюються за допомогою `new Observable` або оператора створення, на них підписується спостерігач, виконуються для доставки сповіщень про `next`/`error`/`complete` до спостерігача, і їхнє виконання може бути припинено. Усі ці чотири аспекти закодовані в екземплярі Observable, але деякі з цих аспектів пов’язані з іншими типами, наприклад Observer і Subscription.
